...
```mermaid
flowchart TD
    A5["A5 Page Dimensions"] --> Margin["Inner Gutter: 20mm / Outer: 15mm"]
    Margin --> DotGrid["5mm Light Grey Dot Grid"]
    Headers["JetBrains Mono / Space Grotesk"] --> PDF["Programmatic PDF Engine"]
    Body["EB Garamond"] --> PDF
    Paper["120gsm Uncoated Cream Stock"] --> Binding["Thread-Sewn Smyth Sewn Signatures"]
    DotGrid --> PDF
    Binding --> PDF
```
