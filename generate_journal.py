...
def main():
    ...
    lines.append('    #set text(size: 18pt, weight: "bold")')
    lines.append(f'    #raw("{metadata["title"]}")')
    lines.append("  ]")
    lines.append("  #v(10pt)")
    lines.append(f'  #text(style: "italic", size: 10pt)[{metadata["subtitle"]}]')
    lines.append("  #v(40pt)")
    ...
    lines.append('  #set text(size: 10.5pt, weight: "bold")')
    lines.append(f'  #raw("{guide["manifesto_header"]}") \\')
    lines.append('  #v(2pt)')
    lines.append('  #set text(size: 9.5pt, weight: "regular")')
    ...
    lines.append('  #v(2pt)')
    lines.append('  #set text(size: 9pt, weight: "regular")')
    ...
    lines.append('  #rect(width: 170pt, height: 170pt, stroke: 0.5pt + rgb("#111111"), fill: rgb("#ffffff"))[')
    lines.append('    #place(center + horizon)[#circle(radius: 80pt, stroke: 0.25pt + rgb("#bbbbbb"))]')
    lines.append('    #place(center + horizon)[#circle(radius: 60pt, stroke: 0.25pt + rgb("#cccccc"))]')
    lines.append('    #place(center + horizon)[#circle(radius: 40pt, stroke: 0.25pt + rgb("#dddddd"))]')
    lines.append('    #place(center + horizon)[#circle(radius: 20pt, stroke: 0.25pt + rgb("#eeeeee"))]')
    lines.append('    #place(top + left)[#line(start: (0pt, 85pt), end: (170pt, 85pt), stroke: 0.25pt + rgb("#b1b1b1"))]')
    lines.append('    #place(top + left)[#line(start: (85pt, 0pt), end: (85pt, 170pt), stroke: 0.25pt + rgb("#b1b1b1"))]')
    lines.append('    #place(top + left)[#line(start: (25pt, 25pt), end: (145pt, 145pt), stroke: 0.25pt + rgb("#d4d4d8"))]')
    lines.append('    #place(top + left)[#line(start: (25pt, 145pt), end: (145pt, 25pt), stroke: 0.25pt + rgb("#d4d4d8"))]')
    ...
    # -------------------------------------------------------------------------
    # PAGES 227-230: THE CHALLENGE TRACKERS
    # -------------------------------------------------------------------------
    ...
    lines.append("// Page 228: Challenge Trackers Page 1 Right")
    lines.append('#system-header("SYSTEM CHALLENGE TRACKERS: FIELD 1/2", "METRIC GRIDS")')
    lines.append("#v(8pt)")
    ...
    lines.append("// Page 229: Challenge Trackers Page 2 Left")
    ...
    lines.append("// Page 230: Challenge Trackers Page 2 Right")
    lines.append('#system-header("SYSTEM CHALLENGE TRACKERS: FIELD 2/2", "METRIC GRIDS")')
    lines.append("#v(8pt)")
    ...
    # -------------------------------------------------------------------------
    # PAGES 231-236: ABSOLUTE DIAGNOSTIC & TRAJECTORY MAPPING
    # -------------------------------------------------------------------------
    print("Generating Absolute Diagnostics spreads...")
    lines.append("// Page 231: Trajectory Mapping Setup")
    ...
    lines.append("#v(10pt)")
    lines.append("#align(center)[")
    lines.append('  #rect(width: 140pt, height: 140pt, stroke: 0.5pt + rgb("#888888"), fill: rgb("#ffffff"))[')
    lines.append('    #place(center + horizon)[')
    lines.append('      #circle(radius: 60pt, stroke: 0.25pt + rgb("#cccccc"))')
    lines.append('      #circle(radius: 45pt, stroke: 0.25pt + rgb("#cccccc"))')
    lines.append('      #circle(radius: 30pt, stroke: 0.25pt + rgb("#cccccc"))')
    lines.append('      #circle(radius: 15pt, stroke: 0.25pt + rgb("#cccccc"))')
    lines.append('      #line(start: (-70pt, 0pt), end: (70pt, 0pt), stroke: 0.25pt + rgb("#a1a1aa"))')
    lines.append('      #line(start: (0pt, -70pt), end: (0pt, 70pt), stroke: 0.25pt + rgb("#a1a1aa"))')
    lines.append('    ]')
    lines.append('    #place(top + center, dy: 4pt)[#set text(size: 5.5pt); #raw("VITALITY (JOY)")]')
    lines.append('    #place(bottom + center, dy: -4pt)[#set text(size: 5.5pt); #raw("DRAIN (EXHAUST)")]')
    lines.append('    #place(left + horizon, dx: 4pt)[#set text(size: 5.5pt); #raw("SMOOTH (FLOW)")]')
    lines.append('    #place(right + horizon, dx: -4pt)[#set text(size: 5.5pt); #raw("STRIATED (ORDER)")]')
    lines.append('  ]')
    lines.append("]")
    lines.append("#v(12pt)")
    ...
    lines.append("// Page 232: Trajectory Mapping Instructions")
    ...
    try:
        ...
        preview_indices = [0, 2, 8, 10, 12, 13, 224, 228, 239]
