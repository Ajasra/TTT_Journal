...
def main():
    ...
    lines.append("- *Cycle 1: Deterritorialization (Days 1–31) \\/\\/ Target: Habit Pruning:* Stripping away rigid, sedimented routines, dropping digital dependencies, and mapping the baseline friction of your workspace to allow new potentials to leak through and disrupt stagnation.")
    lines.append("- *Cycle 2: Re-Organization (Days 32–62) \\/\\/ Target: Assembling Workflows:* Connecting newly discovered habits and building flexible workflows that balance operational discipline with creative deviation, alloying your routines with active creative vectors.")
    lines.append("- *Cycle 3: Sustained Homeorhesis (Days 63–93) \\/\\/ Target: Evolutionary Flow:* Calibrating fluid boundaries to support open flight trajectories without collapsing back into rigid, paranoid structure. The goal is a self-organizing, dynamic equilibrium that moves along a continuous path of growth without freezing up.")
    lines.append("")
    lines.append("#v(6pt)")
    ...
    lines.append("// Page 231: 8-Dimensional vector compilation - Left")
